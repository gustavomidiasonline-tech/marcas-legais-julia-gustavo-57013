    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white space-y-6 sm:space-y-8 animate-fade-in">
          ...
          {/* Headline */}
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-montserrat font-bold leading-tight px-4">
          ...
          <div className="flex flex-col items-center gap-4 pt-4 sm:pt-6 px-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 sm:gap-3 bg-accent hover:bg-accent/90 text-white font-bold py-3 sm:py-4 px-4 sm:px-8 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-xs sm:text-base min-h-[52px] sm:min-h-[56px] w-full sm:w-auto max-w-lg"
            >
              ...
              <span>Tirar Dúvidas no WhatsApp Agora</span>
              <svg className="w-4 h-4 sm:w-5 sm:h-5 transition-transform group-hover:translate-x-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
