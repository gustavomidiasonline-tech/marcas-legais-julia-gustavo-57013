    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white space-y-6 sm:space-y-8 animate-fade-in">
          ...
          {/* CTA */}
          <div className="flex flex-col items-center gap-3 pt-4 px-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            {/* Urgency Banner */}
            <div className="bg-accent/20 border border-accent/40 rounded-lg p-3 w-full max-w-md backdrop-blur-sm">
              <p className="text-xs sm:text-sm text-center font-bold text-white">
            ...
            <Button 
              ...
              size="lg"
              asChild
              className="group w-full max-w-md text-sm sm:text-base shadow-lg hover:shadow-xl h-auto py-4"
            >
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 flex-wrap">
                ...
                <span className="font-semibold">Fazer Consulta Gratuita de Marca</span>
