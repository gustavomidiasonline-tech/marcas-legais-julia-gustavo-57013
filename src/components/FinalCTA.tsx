        ...
        <div className="max-w-4xl mx-auto text-center text-white space-y-6 sm:space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col items-center gap-4 pt-4 sm:pt-6 px-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <Button 
              variant="whatsapp" 
              asChild
              className="group w-full max-w-lg text-sm sm:text-base font-bold shadow-xl hover:shadow-2xl h-auto py-3 sm:py-4 px-6 sm:px-8 rounded-xl transition-all duration-300 hover:scale-105"
            >
